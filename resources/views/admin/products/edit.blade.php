                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 my-2">
                            ...
                            <input type="text" name="order_url" class="form-control"
                                value="{{ old('order_url', $product->order_url) }}">
                            @error('order_url')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 my-2">
                            ...
                            <select name="is_verified" id="is_verified" class="form-control">
                                ...
                                <option value="1" {{ old('is_verified', $product->is_verified) == '1' ? 'selected' : '' }}>Yes</option>
                                <option value="0" {{ old('is_verified', $product->is_verified) == '0' ? 'selected' : '' }}>No</option>
                            </select>
                            @error('is_verified')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
