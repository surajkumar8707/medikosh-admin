    ...
    <div class="card">
        <div class="card-body">
            <div class="container">
                ...
                <form action="{{ route('admin.product-verification.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="row">
                        <div class="col-md-12 my-2">
                            <label>Product <span class="text-danger">*</span></label>
                            <select name="product_id" id="product_id" class="form-control" value="{{ old('product_id') }}" required>
                        ...
                        <div class="col-md-12 my-2">
                            ...
                            <input type="date" name="mfg_date" class="form-control"
                                   value="{{ old('mfg_date') }}" placeholder="MFG Date" required>
                            @error('mfg_date')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12 my-2">
                            ...
                            <input type="date" name="exp_date" class="form-control"
                                   value="{{ old('exp_date') }}" placeholder="Exp Date" required>
                            @error('exp_date')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
