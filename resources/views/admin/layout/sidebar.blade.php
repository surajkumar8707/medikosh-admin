...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">{{ $settings->app_name ?? "Medikosh Nutria" }}</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ isActiveRoute(['admin.products.index', 'admin.products.create', 'admin.products.edit']) }}">
        ...
        <li class="menu-item {{ isActiveRoute(['admin.product-verification.index', 'admin.product-verification.create', 'admin.product-verification.edit']) }}">
            <a href="{{ route('admin.product-verification.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-message-detail"></i>
                <div data-i18n="Analytics">Products Verification</div>
            </a>
        </li>
